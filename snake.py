...
#!!!!!!!!!!!!!!!!!!!!!!!!variable punkte ist global, nicht vergessen !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
def makemenu():
    ...
    while True:
        ...
        button1=Button()
        button1.create_button(DISPLAYSURF,GREEN,100,50,150,50,0,"Spiel",BLACK)

        button2 = Button()
        button2.create_button(DISPLAYSURF, GREEN, 350, 50, 150, 50, 0, "Button2", BLACK)
        ...
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:  # Definition ESC Taste
                ...
                if event.button==1:
                    button1.pressed(pygame.mouse.get_pos())
                    makegame()
...
def makegame():
    ...
    pygame.init()
    FPSCLOCK = pygame.time.Clock()
    DISPLAYSURF = pygame.display.set_mode((BOARD_LENGHT+200, BOARD_HIGHT))
    BASICFONT = pygame.font.Font('freesansbold.ttf', 18)
    ...
    while True:
        ...
        #Punktezahl
        punktefenster=Button()
        punktefenster.create_button(DISPLAYSURF,BLACK,650,100,100,50,1,str(punkte),WHITE)
